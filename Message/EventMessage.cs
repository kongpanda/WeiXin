    ...
    class EventMessage : Message
    {
        ...
        public static EventMessage LoadFromXml(string xml)
        {
            ...
            if (!string.IsNullOrEmpty(xml))
            {
                ...
                {
                    em = new EventMessage();
                    em.FromUserName = element.Element(Utilities.FROM_USERNAME).Value;
                    em.ToUserName = element.Element(Utilities.TO_USERNAME).Value;
                    em.CreateTime = element.Element(Utilities.CREATE_TIME).Value;
